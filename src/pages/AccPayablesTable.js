...
import AccPayablesForm from './AccPayablesForm';
...
// justifyContent="space-between"
  return (
    <>  
        ...
        subTitle="Tabela de Títulos a Pagar - Novo / Atualizar"
        icon={<PaymentsTwoToneIcon fontSize="large" text-align='center'/>}
        />
