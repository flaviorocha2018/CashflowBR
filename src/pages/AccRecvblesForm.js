...
export default function AccRecvblesForm() {
  ...
  return (
    ...
    <form className={classes.root}>
      <Grid container>
    <Grid item xs={10}>
    <TextField variant="outlined" label="Nome do Cliente" onChange={handleInputChange} name="clientName"
    value={values.clientName}sx={{width: "400px", ml:"-2px", mr:"5px", mt: "15px"}}/> 
    <TextField variant="outlined" label="Nº N.F." onChange={handleInputChange} name="issuedInvoiceNumber"
    value={values.issuedInvoiceNumber}sx={{width: "150px", mt: "15px"}}/>
    ...
    <TextField variant="outlined" label="Tipo da Receita" onChange={handleInputChange} name="idReceivables"
    value={values.idReceivables}sx={{width: "340px", ml:"3px", mt: "15px" }}/>
    </Grid>
    ...
    <Grid item xs={6} md={10} style={{ display: "flex"}}>
     <TextField variant="outlined" label="Observações do Título a receber" onChange={handleInputChange} name="detailAccRecvbles"
    value={values.detailAccRecvbles}sx={{width: "610px", ml:"1px"}}/> 
     </Grid></Box> 
